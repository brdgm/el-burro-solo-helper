<template>
  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      <h4><a href="https://boardgamegeek.com/boardgame/368386/el-burro-a-la-granja-game" target="_blank" rel="noopener">{{t('gameTitle')}}</a></h4>
      <dl>
        <dt>Game design</dt>
        <dd>Michael Keller (II), Andreas "ode." Odendahl</dd>
        <dt>Artist</dt>
        <dd>Harald Lieske</dd>
        <dt>Publisher</dt>
        <dd><a href="https://www.spielworxx.de/" target="_blank" rel="noopener">Spielworxx</a></dd>
      </dl>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/el-burro-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/el-burro-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/el-burro-solo-helper</a></dd>
      </dl>
